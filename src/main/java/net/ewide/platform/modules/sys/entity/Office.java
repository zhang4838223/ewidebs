...
//	private String master; 	// 负责人
	...
	private List<UserOffice> userOfficeList;//改动redis中的userOffice存储集合
	
	private String oldName;//原机构名称
	
	public List<UserOffice> getUserOfficeList() {
		return userOfficeList;
	}

	public void setUserOfficeList(List<UserOffice> userOfficeList) {
