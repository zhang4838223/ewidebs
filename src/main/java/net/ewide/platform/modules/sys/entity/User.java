...
import net.ewide.platform.common.utils.excel.annotation.ExcelField;
import net.ewide.platform.common.utils.excel.fieldtype.RoleListType;
...
public class User extends DataEntity<User> {
	...
	private List<Office> officeList = Lists.newArrayList(); //拥有的机构列表
