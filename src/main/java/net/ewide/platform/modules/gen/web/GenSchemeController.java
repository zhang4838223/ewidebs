...
import net.ewide.platform.modules.gen.service.GenSchemeService;
import net.ewide.platform.modules.gen.service.GenTableService;
...
public class GenSchemeController extends BaseController {
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("net.ewide.platform.modules");
		}
