 ...
 */
package net.ewide.platform.modules.act.service.ext;
...
import net.ewide.platform.modules.act.utils.ActUtils;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new net.ewide.platform.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new net.ewide.platform.modules.sys.entity.User(null, userId)))){
