 ...
 */
package net.ewide.platform.modules.act.web;
...
import net.ewide.platform.modules.act.entity.Act;
import net.ewide.platform.modules.act.service.ActTaskService;
...
//		return "modules/act/actTaskForm";
	 ...
	 * 		vars.keys=flag,pass
	 * 		vars.values=1,true
	 * 		vars.types=S,B  @see net.ewide.platform.modules.act.utils.PropertyType
	 */
