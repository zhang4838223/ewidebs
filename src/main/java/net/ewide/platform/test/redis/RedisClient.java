package net.ewide.platform.test.redis;
...
/**
 * redis测试  参考http://www.cnblogs.com/edisonfeng/p/3571870.html
 * @author TianChong
 * @version 2016年4月14日
 */
...
//        config.setTestOnBorrow(false); 
        ...
        jedisPool = new JedisPool(config,"192.168.1.14",6379);
    }
...
//        config.setTestOnBorrow(false); 
    ...
    public void show() {  
//    	System.out.println(jedis.get("subsystemInfo:7ba8f348866c4057b545124c3a5fe5fc"));
//    	jedis.flushDB();
...
//    	System.out.println(jedis.del("users"));
       ...
       int i=0;
        while(it.hasNext()){   
            String key = it.next();   
            if(key.indexOf("userInfo:e15aaba6c6be4710bc9d2c1a543ab5be")>-1){
            	System.out.println(i+"="+key+":"+jedis.get(key));
            }
            else{
//            	System.out.println(key+jedis.lrange(key,0,-1));
        ...
        //jedis.set("aA", "aa1");
//        System.out.println(jedis.get("userInfo:58674f6a1b0c4c8cac3ed0268c6d239f"));
//        jedis.lpush("userOffices:58674f6a1b0c4c8cac3ed0268c6d239f", "aa");
//        jedis.lpush("userOffices:58674f6a1b0c4c8cac3ed0268c6d239f", "bb");
//        jedis.lpush("userOffices:58674f6a1b0c4c8cac3ed0268c6d239f", "cc");
//        jedis.lpush("userOffices:58674f6a1b0c4c8cac3ed0268c6d239f", "dd");
//        jedis.lpush("userOffices:58674f6a1b0c4c8cac3ed0268c6d239f", "ee");
//        jedis.lrem("userOffices:58674f6a1b0c4c8cac3ed0268c6d239f", 0, "aa");
//        System.out.println(jedis.lrange("menus", 0, -1));
