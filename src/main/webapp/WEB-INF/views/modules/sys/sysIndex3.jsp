...
#menu-2 .panel-default>.panel-heading {
...
#menu-2 .panel a:focus, #menu-2 .panel a:hover {
	text-decoration: none;
}
.panel-body>ul.nav-list>li>a{
padding-left:0;
}
li ul.nav-list{
    padding-left: 0;
	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav navbar-nav nav-pills pull-right">
					<li><a
