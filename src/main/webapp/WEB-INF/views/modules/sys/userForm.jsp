...
<body>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/save" method="post" class="form-horizontal">
		...
		<div class="form-group">
			<label class="control-label pull-left">头像:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">归属公司:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">工号:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">登录名:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">是否允许登录:</label>
			<div class="controls">
		...
		<c:if test="${not empty user.id}">
			...
			<div class="form-group">
				<label class="control-label pull-left">最后登陆:</label>
				<div class="controls">
