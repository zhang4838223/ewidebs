...
<body>
	...
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/save" method="post" class="form-horizontal">
		...
		<div class="form-group">
			<label class="control-label pull-left">上级机构:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">归属区域:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">机构名称:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">机构编码:</label>
			<div class="controls">
				<form:input path="code" htmlEscape="false" maxlength="50" class="form-control"/>
			</div>
		</div>
		<div class="form-group">
			<label class="control-label pull-left">机构类型:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">机构级别:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">是否可用:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">主负责人:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">副负责人:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">传真:</label>
			<div class="controls">
		...
		<c:if test="${empty office.id}">
			<div class="form-group">
				<label class="control-label pull-left">快速添加下级部门:</label>
