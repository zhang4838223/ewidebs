...
<body>
	...
	<form:form id="searchForm" modelAttribute="oaNotify" action="${ctx}/oa/oaNotify/${oaNotify.self?'self':''}" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			<li><label class="pull-left">标题：</label>
				<form:input path="title" htmlEscape="false" maxlength="200" class="input-medium form-control pull-left"/>
			</li>
			<li><label class="pull-left">类型：</label>
				<form:select path="type" class="input-medium form-control pull-left">
