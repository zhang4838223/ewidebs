...
<body>
	...
	<form:form id="searchForm" modelAttribute="genTable" action="${ctx}/gen/genTable/" method="post" class="breadcrumb form-search">
		...
		<label class="pull-left">表名：</label><form:input path="nameLike" htmlEscape="false" maxlength="50" class="input-medium form-control pull-left"/>
		<label class="pull-left">说明：</label><form:input path="comments" htmlEscape="false" maxlength="50" class="input-medium form-control pull-left"/>
		<label class="pull-left">父表表名：</label><form:input path="parentTable" htmlEscape="false" maxlength="50" class="input-medium form-control pull-left"/>
