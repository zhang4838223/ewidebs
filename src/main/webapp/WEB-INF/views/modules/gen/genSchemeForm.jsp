...
<body>
	...
	<form:form id="inputForm" modelAttribute="genScheme" action="${ctx}/gen/genScheme/save" method="post" class="form-horizontal">
		...
		<div class="form-group">
			<label class="control-label pull-left">方案名称:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">模板分类:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">生成包路径:</label>
			<div class="controls">
				<form:input path="packageName" htmlEscape="false" maxlength="500" class="required input-xlarge form-control"/>
				<span class="help-inline">建议模块包：net.ewide.platform.modules</span>
			</div>
		</div>
		<div class="form-group">
			<label class="control-label pull-left">生成模块名:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">生成子模块名:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">生成功能描述:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">生成功能名:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">生成功能作者:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">业务表名:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">生成选项:</label>
			<div class="controls form-control" style="border:none;box-shadow:none;-webkit-box-shadow:none;">
