...
<body>
	...
	<form id="inputForm" action="${ctx}/act/model/create" target="_blank" method="post" class="form-horizontal">
		<div class="form-group">
			<label class="control-label pull-left">流程分类：</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left ">模块名称：</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">模块标识：</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">模块描述：</label>
			<div class="controls">
