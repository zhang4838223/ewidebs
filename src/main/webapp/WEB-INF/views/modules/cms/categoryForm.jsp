...
<body>
	...
	<form:form id="inputForm" modelAttribute="category" action="${ctx}/cms/category/save" method="post" class="form-horizontal">
		...
		<div class="form-group">
			<label class="control-label pull-left">归属机构:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">上级栏目:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">栏目模型:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">栏目名称:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">目标:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">描述:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">在导航中显示:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">在分类页中显示列表:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left" title="默认展现方式：有子栏目显示栏目列表，无子栏目显示内容列表。">展现方式:</label>
			<div class="controls">
