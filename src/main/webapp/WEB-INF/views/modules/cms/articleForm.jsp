...
<body>
	...
	<form:form id="inputForm" modelAttribute="article" action="${ctx}/cms/article/save" method="post" class="form-horizontal">
		...
		<div class="form-group">
			<label class="control-label pull-left">归属栏目:</label>
			<div class="controls">
		...
		<div class="form-group">
			...
			<div class="controls">
				<form:input path="title" htmlEscape="false" maxlength="200" class="input-xxlarge measure-input required form-control"/>
			<%-- 	&nbsp;<label>颜色:</label>
		...
		<div class="form-group">
			<label class="control-label pull-left">颜色:</label>
			<div class="controls">
			<form:select path="color" class="input-mini form-control">
					<form:option value="" label="默认"/>
					<form:options items="${fns:getDictList('color')}" itemLabel="label" itemValue="value" htmlEscape="false" />
				</form:select></div>
			</div>
		...
		<div class="form-group">
			<label class="control-label pull-left">关键字:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">权重:</label>
			<div class="controls">
				<form:input path="weight" htmlEscape="false" maxlength="200" class="input-mini required digits form-control"/>&nbsp;
				<span>
					<input id="weightTop" type="checkbox" onclick="$('#weight').val(this.checked?'999':'0')"><label for="weightTop">置顶</label>
				</span>
				&nbsp;过期时间：
				<input id="weightDate" name="weightDate" type="text" readonly="readonly" maxlength="20" class="input-small Wdate form-control"
		...
		<div class="form-group">
			<label class="control-label pull-left">摘要:</label>
			<div class="controls">
				<form:textarea path="description" htmlEscape="false" rows="4" maxlength="200" class="input-xxlarge form-control"/>
			</div>
		</div>
		<div class="form-group">
			<label class="control-label pull-left">缩略图:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">正文:</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">是否允许评论:</label>
			<div class="controls">
		...
		<shiro:hasPermission name="cms:article:audit">
			<div class="form-group">
				<label class="control-label pull-left">发布状态:</label>
				<div class="controls">
		...
		<shiro:hasPermission name="cms:category:edit">
            <div class="form-group">
                <label class="control-label pull-left">自定义内容视图:</label>
                <div class="controls">
            ...
            <div class="form-group">
                <label class="control-label pull-left">自定义视图参数:</label>
                <div class="controls">
		...
		<c:if test="${not empty article.id}">
			<div class="form-group">
				<label class="control-label pull-left">查看评论:</label>
				<div class="controls">
