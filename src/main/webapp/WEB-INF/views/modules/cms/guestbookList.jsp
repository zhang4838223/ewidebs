...
<body>
	...
	<form:form id="searchForm" modelAttribute="guestbook" action="${ctx}/cms/guestbook/" method="post" class="breadcrumb form-search">
		...
		<label class="pull-left">分类：</label><form:select id="type" path="type" class="input-small form-control pull-left"><form:option value="" label=""/><form:options items="${fns:getDictList('cms_guestbook')}" itemValue="value" itemLabel="label" htmlEscape="false"/></form:select>
		<label class="pull-left">内容 ：</label><form:input path="content" htmlEscape="false" maxlength="50" class="input-small form-control pull-left"/>
