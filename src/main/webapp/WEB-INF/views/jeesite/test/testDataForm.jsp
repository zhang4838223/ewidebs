...
<body>
	...
	<form:form id="inputForm" modelAttribute="testData" action="${ctx}/test/testData/save" method="post" class="form-horizontal">
		...
		<div class="form-group">
			<label class="control-label pull-left">归属用户：</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">归属部门：</label>
			<div class="controls">
		...
		<div class="form-group">
			...
			<div class="controls">
				<form:input path="name" htmlEscape="false" maxlength="100" class="input-xlarge form-control pull-left"/>
			</div>
		</div>
		<div class="form-group">
			<label class="control-label pull-left">性别：</label>
			<div class="controls" id="sexWrap">
				<form:radiobuttons path="sex" items="${fns:getDictList('sex')}" itemLabel="label" itemValue="value" htmlEscape="false" class="form-control"/>
			</div>
		</div>
		<div class="form-group">
			<label class="control-label pull-left">加入日期：</label>
			<div class="controls">
		...
		<div class="form-group">
			<label class="control-label pull-left">备注信息：</label>
			<div class="controls">
