...
<body>
	...
	<form:form id="searchForm" modelAttribute="testData" action="${ctx}/test/testData/" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form ">
			<li>
			<label class="pull-left">归属用户：</label>
			...
			<li><label class="pull-left">归属部门：</label>
			...
			<li><label class="pull-left">归属区域：</label>
			...
			<li><label class="pull-left">名称：</label>
				<form:input path="name" htmlEscape="false" maxlength="100" class="input-medium form-control pull-left"/>
			</li>
			<li><label class="pull-left">性别：</label>
				<form:radiobuttons path="sex" items="${fns:getDictList('sex')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
			</li>
			<li><label class="pull-left">加入日期：</label>
				<input name="beginInDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate form-control pull-left"
					value="<fmt:formatDate value="${testData.beginInDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false});"/> 
					<span class="pull-left" style="font-size:14px;">--</span> 
				<input name="endInDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate form-control pull-left"
